package ma.xproce.client;

import ma.xproce.client.dao.entities.Client;
import ma.xproce.client.dao.repositories.ClientRepository;
...
public class ClientApplication {
    ...
    CommandLineRunner initialiserBaseH2(ClientRepository clientRepository) {
        return args -> {
            clientRepository.save(new Client(Long.parseLong("1"), "Rabab SELIMANI"
                    , Float.parseFloat("23")));
